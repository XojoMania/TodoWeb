...
#tag Events lstTasks
	#tag Event
		Sub CellClick(Row As Integer, Column As Integer)
		  ...
		  if me.cell(Row, column) = &u25A1 then
		    lstTasks.RemoveRow(Row)
		  end if
	...
	#tag Event
		Sub Action()
		  if txtTask.Text <> "" then
		    lstTasks.AddRow(str(App.taskId), txtTask.Text, &u25A1)
